Gem::Specification.new do |s|
  ...
  s.files             = [
    ...
    'app/controllers/admin/event_enquiry_settings_controller.rb',
    'app/controllers/event_inquiries_controller.rb',
    'app/helpers',
    'app/helpers/event_inquiries_helper.rb',
    'app/mailers',
    'app/mailers/event_enquiry_mailer.rb',
    'app/models',
    'app/models/event_enquiry.rb',
    'app/models/event_enquiry_setting.rb',
    'app/views',
    'app/views/admin',
    'app/views/admin/event_inquiries',
    'app/views/admin/event_inquiries/_event_enquiry.html.erb',
    ...
    'app/views/admin/event_enquiry_settings',
    'app/views/admin/event_enquiry_settings/_confirmation_email_form.html.erb',
    'app/views/admin/event_enquiry_settings/_notification_recipients_form.html.erb',
    'app/views/admin/event_enquiry_settings/edit.html.erb',
    'app/views/event_inquiries',
    'app/views/event_inquiries/new.html.erb',
    'app/views/event_inquiries/thank_you.html.erb',
    'app/views/event_enquiry_mailer',
    'app/views/event_enquiry_mailer/confirmation.html.erb',
    'app/views/event_enquiry_mailer/notification.html.erb',
    'config',
    'config/locales',
    ...
    'features/step_definitions/event_enquiry_steps.rb',
    'features/support',
    ...
    'spec',
    'spec/models',
    'spec/models/event_enquiry_spec.rb'
  ]
  s.require_path = 'lib'
