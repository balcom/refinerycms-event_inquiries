...
Feature: Manage EventInquiries
  ...
  Background:
    ...
    And I have an event_enquiry from "David Jones" with email "dave@refinerycms.com" and message "Hello, I really like your website.  Was it hard to build and maintain or could anyone do it?"
  ...
  Scenario: EventInquiries Show
    When I go to the list of event_inquiries
    And I follow "Read the event_enquiry"
    ...
    And I should see "Remove this event_enquiry forever"

  Scenario: EventInquiries Delete
    When I go to the list of event_inquiries
    And I follow "Read the event_enquiry"
    And I follow "Remove this event_enquiry forever"
